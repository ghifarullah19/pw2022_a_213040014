  ...
  <body>
    ...
    <!-- akhir navbar -->
        ...
        <section id="film-1">
          <div class="film-1">
            <div class="container">
              <h2 class="film-title text-center">Data Film</h2>
              ...
              <div class="mb-3">
                  <img src="img/<?= $mov['gambar_movie']; ?>" width="200"> <br>
                </div>
                ...
                <a href="<?= $mov['link_movie']; ?>" class="btn btn-outline-success">Tonton Film</a>
